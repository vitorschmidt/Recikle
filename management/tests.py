...
class TestB2(CompanyViewTestCase):
    ...
    def test_B211(self):
        """COMPANY VIEW: POST /api/companies/ duplicate data (superuser credentials)"""
        self.superuser_post_duplicate_company()

    def test_B212(self):
        """COMPANY VIEW: POST /api/companies/ invalid data (superuser credentials)"""
        self.superuser_post_invalid_company()

    # PATH /api/companies/<int:id>/

    def test_B213(self):
        """COMPANY VIEW: GET /api/companies/<int:id>/ own company (superuser credentials)"""
        self.superuser_get_own_companyid()

    def test_B214(self):
        """COMPANY VIEW: GET /api/companies/<int:id>/ other's company (superuser credentials)"""
        self.superuser_get_others_companyid()

    def test_B215(self):
        """COMPANY VIEW: GET /api/companies/<int:id>/ company's own company (company credentials)"""
        self.company_get_own_companyid()

    def test_B216(self):
        """COMPANY VIEW: GET /api/companies/<int:id>/ (person credentials)"""
        self.person_get_companyid()

    def test_B217(self):
        """COMPANY VIEW: GET /api/companies/<int:id>/ (anonymous)"""
        self.anonymous_get_companyid()

    def test_B218(self):
        """COMPANY VIEW: GET /api/companies/<int:id>/ (invalid credentials)"""
        self.invalid_get_companyid()

    def test_B219(self):
        """COMPANY VIEW: PATCH /api/companies/<int:id>/ (superuser credentials)"""
        self.superuser_patch_company_id()

    def test_B220(self):
        """COMPANY VIEW: PATCH /api/companies/<int:id>/ duplicate (superuser credentials)"""
        self.superuser_patch_duplicate_company_id()

    def test_B221(self):
        """COMPANY VIEW: PATCH /api/companies/<int:id>/ (random user)"""
        self.random_usercompany_patch_company_id()

    def test_B222(self):
        """COMPANY VIEW: PATCH /api/companies/<int:id>/ invalid data (random user)"""
        self.random_usercompany_patch_invalid_company_id()

    # PATH /api/companies/<int:id>/discards/

    def test_B223(self):
        """COMPANY VIEW: GET /api/companies/<int:id>/discards/ (random company's)"""
        self.random_usercompany_get_company_discards()
        
    def test_B224(self):
        """COMPANY VIEW: GET /api/companies/<int:id>/discards/ (superuser credentials)"""
        self.superuser_get_company_discards()

    def test_B225(self):
        """COMPANY VIEW: POST /api/companies/<int:id>/discards/ (superuser credentials)"""
        self.superuser_post_company_discard()

    def test_B226(self):
        """COMPANY VIEW: POST /api/companies/<int:id>/discards/ (random company's)"""
        self.random_usercompany_post_own_company_discard()

    def test_B227(self):
        """COMPANY VIEW: POST /api/companies/<int:id>/discards/ invalid data (random company's)"""
        self.random_usercompany_post_own_company_invalid_discard()

    # PATH /api/companies/<int:id>/discards/<int:discard_id>/

    def test_B228(self):
        """COMPANY VIEW: GET /api/companies/<int:id>/discards/<int:discard_id>/ (superuser credentials)"""
